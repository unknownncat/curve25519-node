...
import { getCurveBindings } from "./internal/wasm-runtime.js";
...
export function x25519PublicKeyFromPrivateKeyObject(
  ...
  return asBytes32(getCurveBindings().x25519PublicKey(privateKey.bytes), "x25519 public key");
}
...
export function x25519SharedKeyFromKeyObjects(
  ...
  return asBytes32(
    getCurveBindings().x25519SharedKey(privateKey.bytes, publicKey.bytes),
    "x25519 shared key",
  );
}
...
export function ed25519PublicKeyFromPrivateKeyObject(
  ...
  return asBytes32(getCurveBindings().ed25519PublicKey(privateKey.bytes), "ed25519 public key");
}
...
export function ed25519SignWithPrivateKey(
  ...
  return asBytes64(getCurveBindings().ed25519Sign(privateKey.bytes, msg), "ed25519 signature");
}
...
export function ed25519VerifyWithPublicKey(
  ...
  return getCurveBindings().ed25519Verify(publicKey.bytes, msg, signature64);
}
